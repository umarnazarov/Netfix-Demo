    ...
    return (
        <div id='faq' className='main-content-questions'>
            ...
            <div className='main-content-question'>
                ...
                <i onClick={() => handleTooggle('p1')} className={`fas fa-plus ${toggle === 'p1' ? 'fa-rotate' : ""}`} ></i>
            ...
            <div className='main-content-question'>
                ...
                <i onClick={() => handleTooggle('p2')} className={`fas fa-plus ${toggle === 'p2' ? 'fa-rotate' : ""}`}></i>
            ...
            <div className='main-content-question'>
                ...
                <i onClick={() => handleTooggle('p3')} className={`fas fa-plus ${toggle === 'p3' ? 'fa-rotate' : ""}`}></i>
            ...
            <div className='main-content-question'>
                ...
                <i onClick={() => handleTooggle('p4')} className={`fas fa-plus ${toggle === 'p4' ? 'fa-rotate' : ""}`}></i>
            ...
            <div className='main-content-question'>
                ...
                <i onClick={() => handleTooggle('p5')} className={`fas fa-plus ${toggle === 'p5' ? 'fa-rotate' : ""}`}></i>
            ...
            <div className='main-content-question'>
                ...
                <i onClick={() => handleTooggle('p7')} className={`fas fa-plus ${toggle === 'p6' ? 'fa-rotate' : ""}`}></i>
